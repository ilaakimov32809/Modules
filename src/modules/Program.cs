...
class ModularProgramming
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine("Максимум трех выражений:");
        double a = 1.5, b = 2.0;
        double result74 = MaxOfExpressions(a, b);
        Console.WriteLine($"При a={a}, b={b}: максимум = {result74:F3}\n");

        Console.WriteLine("Подсчет повторений числа в массиве:");
        ...
        Console.WriteLine("Подсчет символов в строке:");
        ...
        Console.WriteLine("Максимальный элемент и количество максимумов:");
        ...
        Console.WriteLine("Замена элементов диагонали матрицы на нули:");
        int[,] matrix716 = {
            {1, 2, 3},
            {4, 5, 6},
            {7, 8, 9}
        ...
        Console.WriteLine("Замена отрицательных чисел на единицы:");
        int[,] matrix717 = {
            {1, -2, 3},
            {-4, 5, -6},
            {7, -8, 9}
        ...
        Console.WriteLine("Сумма минимальных элементов по строкам:");
        int[,] matrix718 = {
            {3, 1, 4},
            {2, 5, 1},
            {7, 3, 2}
